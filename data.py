...
def buildData(validId) -> None:
    try:
        os.remove('/content/sample_data/data/processed-valid-data.csv')
        os.remove('/content/sample_data/data/processed-invalid-data.csv')
    except: pass

    labelledData = collectLabelledData('/content/sample_data/data/raw-data.csv', validId)
    processLabelledData(labelledData, '/content/sample_data/data/processed-valid-data.csv', '/content/sample_data/data/processed-invalid-data.csv')