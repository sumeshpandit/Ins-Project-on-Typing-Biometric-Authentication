...
def prepareDataset(validDataFileName, invalidDataFileName, dataSplit, invalidCount=1000, useValidCount=False) -> tuple:
    ...
    validDataframe = np.concatenate((validDataframe.to_numpy(), validDataframe.to_numpy(), validDataframe.to_numpy(), validDataframe.to_numpy()))
    ...
    invalidDataframe = invalidDataframe.to_numpy()
...
def runModel() -> tuple:
    data = prepareDataset('/content/sample_data/data/processed-valid-data.csv', '/content/sample_data/data/processed-invalid-data.csv', \
